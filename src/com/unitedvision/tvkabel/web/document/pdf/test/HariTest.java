...
import com.unitedvision.tvkabel.web.document.pdf.HariPdfView;
...
public class HariTest extends HariPdfView {
	...
	public static void main(String[] args) {
        ...
        try {
			...
			List<PelangganEntity> list = (List<PelangganEntity>)rekapService.rekapHarian(pegawai, DateUtil.getDate("12-12-2014"));
