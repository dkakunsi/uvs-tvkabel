...
public class AlamatController extends AbstractController {
	...
	public @ResponseBody ListKelurahanRestResult getAllKelurahan() {
		List<? extends Kelurahan> list = kelurahanService.getAll();
		
		return ListKelurahanRestResult.create("Berhasil!", KelurahanModel.createListModel(list));
	}
	...
	public @ResponseBody ListKelurahanRestResult getKelurahanByKecamatan(@PathVariable Integer kecamatanId) {
		try {
			...
			List<? extends Kelurahan> list = kelurahanService.getByKecamatan(kecamatan);
	...
	public @ResponseBody ListKecamatanRestResult getAllKecamatan() {
		List<? extends Kecamatan> list = kecamatanService.getAll();
		
		return ListKecamatanRestResult.create("Berhasil!", KecamatanModel.createListModel(list));
	}
	...
	public @ResponseBody ListKecamatanRestResult getKecamatanByKota(@PathVariable Integer kotaId) {
		try {
			...
			List<? extends Kecamatan> list = kecamatanService.getByKota(kota);
	...
	public @ResponseBody ListKotaRestResult getAllKota() {
		List<? extends Kota> list = kotaService.getAll();
		
		return ListKotaRestResult.create("Berhasil!", KotaModel.createListModel(list));
	}
}
