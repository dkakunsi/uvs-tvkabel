...
public final class Pegawai extends CodableDomain implements Operator, Removable {
	...
	/**
	 * If kredensi is null, create a new one.
	 */
	private void setKredensi() {
		if (kredensi == null)
			kredensi = new Kredensi();
	}
