...
public final class Pembayaran extends CodableDomain {
	...
	public String getTanggalBayarStr() {
		return DateUtil.toString(tanggalBayar);
	}
	...
	/**
	 * If pelanggan is null, create a new one.
	 */
	...
	/**
	 * If pegawai is null, create a new one.
	 */
	...
	/**
	 * If tagihan is null, create a new one.
	 */
	private void setTagihan() {
		if (tagihan == null)
			tagihan = new Tagihan();
	}
	...
	public String getBulanStr() {
		return getBulan().name();
	}
	
	public void setBulanStr(String bulanStr) {
		tagihan.setBulan(Month.valueOf(bulanStr));
	}
	...
	public void setIdPegawai(int idPegawai) throws EmptyIdException {
		setPegawai();
	...
	public String getKodePegawai() {
		return pegawai.getKode();
	}
	
	public void setKodePegawai(String kodePegawai) throws EmptyCodeException {
		setPegawai();
		pegawai.setKode(kodePegawai);
	}
	...
	public void setIdPelanggan(int idPelanggan) throws EmptyIdException {
		setPelanggan();
	...
	public void setKodePelanggan(String kodePelanggan) throws EmptyCodeException {
		setPelanggan();
		pelanggan.setKode(kodePelanggan);
	}
	...
	public void setProfesiPelanggan(String profesiPelanggan) {
		setPelanggan();
		pelanggan.setProfesi(profesiPelanggan);
	}
